            ...
            <v-row>
              ...
              <v-col cols="12" sm="6">
                ...
                <v-row class="me-details">
                  <v-col class="text-center text-sm-left" cols="12" sm="6" lg="3">Name:</v-col>
                  <v-col class="text-center text-sm-left" cols="12" sm="6" lg="3">Matt DeKok</v-col>
                  <v-col class="text-center text-sm-left" cols="12" sm="6" lg="3">Age:</v-col>
                  <v-col class="text-center text-sm-left" cols="12" sm="6" lg="3">{{age(new Date(1988, 5, 9))}}</v-col>
                  <v-col class="text-center text-sm-left" cols="12" sm="6" lg="3">Location:</v-col>
                  <v-col class="text-center text-sm-left" cols="12" sm="6" lg="3">Huron, SD</v-col>
                  <v-col class="text-center text-sm-left" cols="12" sm="6" lg="3">Experience:</v-col>
